...
<head>
  ...
  <title><?php echo $settings_r['site_title'] ?> - โปรไฟล์</title>
</head>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 my-5 px-4">
        <h2 class="fw-bold">โปรไฟล์</h2>
        <div style="font-size: 14px;">
          <a href="index.php" class="text-secondary text-decoration-none">หน้าแรก</a>
          <span class="text-secondary"> > </span>
          <a href="#" class="text-secondary text-decoration-none">โปรไฟล์</a>
        </div>
      </div>
      ...
      <div class="col-12 mb-5 px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm">
          <form id="info-form">
            <h5 class="mb-3 fw-bold">ข้อมูล</h5>
            <div class="row">
            ...
            <button type="submit" class="btn text-white custom-bg shadow-none">บันทึก</button>
          </form>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-5 px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm">
          <form id="profile-form">
            <h5 class="mb-3 fw-bold">รูปโปรไฟล์</h5>
      ...
      <div class="col-md-8 mb-5 px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm">
          <form id="pass-form">
            <h5 class="mb-3 fw-bold">เปลี่ยนรหัสผ่าน</h5>
            <div class="row">
            ...
            <button type="submit" class="btn text-white custom-bg shadow-none">บันทึกรหัสผ่าน</button>
          </form>
        </div>
      </div>
