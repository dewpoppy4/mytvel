  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link me-2" href="index.php">หน้าแรก</a>
        </li>
        <li class="nav-item">
          <a class="nav-link me-2" href="tvels.php">สถานที่ท่องเที่ยว</a>
        </li>
        <li class="nav-item">
          <a class="nav-link me-2" href="rooms.php">ที่พัก</a>
        </li>
        <li class="nav-item">
          <a class="nav-link me-2" href="restaurants.php">ร้านอาหาร</a>
        </li>
        <li class="nav-item">
      ...
      <form id="login-form">
        <div class="modal-header">
          <h5 class="modal-title d-flex align-items-center">
            <i class="bi bi-person-circle fs-3 me-2"></i> เข้าสู่ระบบผู้ใช้
          </h5>
          <button type="reset" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="mb-3">
            <label class="form-label">อีเมล / เบอร์มือถือ</label>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form id="register-form">
        <div class="modal-header">
          <h5 class="modal-title d-flex align-items-center">
            <i class="bi bi-person-lines-fill fs-3 me-2"></i> สมัครสมาชิก
          </h5>
          <button type="reset" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="forgot-form">
        <div class="modal-header">
          <h5 class="modal-title d-flex align-items-center">
            <i class="bi bi-person-circle fs-3 me-2"></i> ลืมรหัสผ่าน?
          </h5>
        </div>
        <div class="modal-body">
          <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
          หมายเหตุ: ลิงก์จะถูกส่งไปยังอีเมล์ของคุณเพื่อรีเซ็ตรหัสผ่านของคุณ!
          </span>
          <div class="mb-4">
            <label class="form-label">อีเมล</label>
          ...
          <div class="mb-2 text-end">
            ...
            <button type="submit" class="btn btn-dark shadow-none"> ส่งลิงค์</button>
          </div>
        </div>
      </form>
    </div>
