...
<head>
  ...
  <title><?php echo $settings_r['site_title'] ?> - รายละเอียดร้านอาหาร</title>
</head>
...
<body class="bg-light">
  ...
  $restaurant_res = select("SELECT * FROM `restaurants` WHERE `id`=? AND `status`=? AND `removed`=?", [$data['id'], 1, 0], 'iii');

  if (mysqli_num_rows($restaurant_res) == 0) {
    redirect('restaurants.php');
  }

  $restaurant_data = mysqli_fetch_assoc($restaurant_res);
  ?>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 my-5 mb-4 px-4">
        <h2 class="fw-bold"><?php echo $restaurant_data['name'] ?></h2>
        <div style="font-size: 14px;">
          <a href="index.php" class="text-secondary text-decoration-none">หน้าแรก</a>
          <span class="text-secondary"> > </span>
          <a href="restaurants.php" class="text-secondary text-decoration-none">ร้านอาหาร</a>
        </div>
      </div>
      ...
      <div class="col-lg-7 col-md-12 px-4">
        <div id="restaurantCarousel" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <?php
            $restaurant_img = RESTAURANTS_IMG_PATH . "thumbnail.jpg";
            $img_q = mysqli_query($con, "SELECT * FROM `restaurant_images` 
                WHERE `restaurant_id`='$restaurant_data[id]'");
            ...
            if (mysqli_num_rows($img_q) > 0) {
              ...
              while ($img_res = mysqli_fetch_assoc($img_q)) {
                echo "
                    <div class='carousel-item $active_class'>
                      <img src='" . RESTAURANTS_IMG_PATH . $img_res['image'] . "' class='d-block w-100 rounded'>
                    </div>
                  ";
                $active_class = '';
              }
              ...
              echo "<div class='carousel-item active'>
                  <img src='$restaurant_img' class='d-block w-100'>
                </div>";
            }
            ?>
          </div>
  ...
  <div class="col-lg-4">
    <div class="card border-0 shadow-sm rounded-3">
      ...
      if(isset($_SESSION['login']) && $_SESSION['login']==true){
        echo<<<review
          <a href="review.php?item_id=$restaurant_data[id]&item_type=restaurant" 
  ...
  <div class="mb-5">
    ...
    <p class="text-break" style="text-indent: 2em; white-space: pre-line;">
      <?php echo $restaurant_data['description'] ?>
    </p>
  </div>
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      $review_q = "SELECT rr.*, uc.name AS uname, uc.profile 
                   ...
                   WHERE rr.restaurant_id = '$restaurant_data[id]'
