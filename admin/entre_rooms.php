...
<head>
  ...
  <title>แผงผู้ประกอบการ - ที่พัก</title>
...
<body class="bg-light">
      ...
      <form id="add_room_form" autocomplete="off">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">เพิ่มที่พัก</h5>
          </div>
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                <label class="form-label fw-bold">ผู้ใหญ่ (มากสุด.)</label>
                <input type="number" min="1" name="adult" class="form-control shadow-none" required>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label fw-bold">เด็ก (มากสุด.)</label>
  ...
  <div class="modal fade" id="edit-room" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <form id="edit_room_form" autocomplete="off">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">แก้ไขที่พัก</h5>
          </div>
          <div class="modal-body">
            <div class="row">
              <div class="col-md-6 mb-3">
  ...
  <script src="scripts/entre_rooms.js"></script>
