...
<head>
  ...
  <title>แผงผู้ดูแลระบบ - แผงควบคุม</title>
...
<body class="bg-light">
    ...
    <div class="row">
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
          <h5>การวิเคราะห์การจอง</h5>
          <select class="form-select shadow-none bg-light w-auto" onchange="booking_analytics(this.value)">
            <option value="1">30 วันที่ผ่านมา</option>
            <option value="2">90 วันที่ผ่านมา</option>
            <option value="3">1 ปีที่ผ่านมา</option>
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
          <h5>ผู้ใช้, แบบสอบถาม, รีวิว การวิเคราะห์</h5>
  ...
  <script src="scripts/entre_dashboard.js"></script>
</body>
