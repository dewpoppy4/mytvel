...
<head>
  ...
  <title>แผงควบคุมผู้ดูแลระบบ - การจองใหม่</title>
...
<body class="bg-light">
  ...
  <div class="container-fluid" id="main-content">
    <div class="row">
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        <h3 class="mb-4">การจองใหม่</h3>

        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">

            <div class="text-end mb-4">
              <input type="text" oninput="get_bookings(this.value)" class="form-control shadow-none w-25 ms-auto" placeholder="พิมพ์เพื่อค้นหา...">
            </div>
              ...
              <table class="table table-hover border" style="min-width: 1200px;">
                <thead>
                  <tr class="bg-dark text-light">
                    ...
                    <th scope="col">รายละเอียดที่พัก</th>
  ...
  <script src="scripts/entre_new_bookings.js"></script>
