...
<head>
  ...
  <title>แผงผู้ดูแลระบบ - พื้นหลัง</title>
            ...
            <form id="carousel_s_form">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" onclick="carousel_picture.value=''" class="btn text-secondary shadow-none" data-bs-dismiss="modal">ยกเลิก</button>
