<?php 
  ...
  if(isset($_GET['fetch_rooms']))
  {
    ...
    while($room_data = mysqli_fetch_assoc($room_res))
    {
      ...
      if(!$settings_r['shutdown']){
        ...
        $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])' 
          class='btn btn-sm w-100 text-white custom-bg shadow-none mb-2'>จองเลย</button>";
      }
          ...
          <div class='row g-0 p-3 align-items-center'>
            ...
            <div class='col-md-5 px-lg-3 px-md-3 px-0'>
              ...
              <div class='facilities mb-3'>
                <h6 class='mb-1'>สิ่งอำนวยความสะดวกเพิ่มเติม</h6>
                $facilities_data
              </div>
              <div class='guests'>
    ...
    if($count_rooms>0){
      ...
      echo"<h3 class='text-center text-danger'>ไม่พบห้องพัก!</h3>";
    }
  }
?>